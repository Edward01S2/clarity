<section id="feat-block" class="pb-12 lg:mt-16 xl:mt-20 xl:pb-16">
  <div class="container mx-auto px-6 lg:px-8">
    <div class="max-w-xs mx-auto md:max-w-none xl:max-w-6xl xl:mx-auto">
      <h2 class="text-2xl text-center leading-8 font-semibold text-c-blue-400 mb-8 md:text-3xl md:leading-normal lg:text-4xl lg:mb-8 lg:leading-tight">{!! $title !!}</h2>
        ...
        @foreach($items as $item)
          <div class="text-center focus:outline-none md:w-1/3">
            <div class="bg-c-blue-100 rounded-full inline-block p-6 mb-4 mx-auto">
              <img class="h-20 w-20" src="{!! $item['icon']['url'] !!}" alt="">
            </div>
