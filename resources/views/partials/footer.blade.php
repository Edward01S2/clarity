<footer>
  <div class="container mx-auto px-6 lg:px-8">
    <div class="flex flex-col items-center space-y-6 pt-12 pb-8 border-b border-c-gray-100 md:flex-row md:space-y-0 md:items-center md:justify-between md:flex-wrap lg:pt-16 lg:pb-12 xl:space-x-16">
      ...
      <div class="flex flex-col space-y-6 items-center md:flex-row md:space-y-0 md:space-x-6 md:pt-6 lg:space-x-8 lg:flex-grow xl:space-x-0 xl:justify-between xl:pt-0">
